...
public class ClientEntityQuery extends EntityPathBase<ClientEntity> {
    ...
    public final ListPath<com.kuartz.api.auth.entity.ResourceEntity, ResourceEntityQuery> reourceList = this.<com.kuartz.api.auth.entity.ResourceEntity, ResourceEntityQuery>createList("reourceList", com.kuartz.api.auth.entity.ResourceEntity.class, ResourceEntityQuery.class, PathInits.DIRECT2);
