...
public class RoleEntityQuery extends EntityPathBase<RoleEntity> {
    ...
    public final ListPath<com.kuartz.api.auth.entity.RolePrivilegeEntity, RolePrivilegeEntityQuery> rolePrivilegeRelationList = this.<com.kuartz.api.auth.entity.RolePrivilegeEntity, RolePrivilegeEntityQuery>createList("rolePrivilegeRelationList", com.kuartz.api.auth.entity.RolePrivilegeEntity.class, RolePrivilegeEntityQuery.class, PathInits.DIRECT2);
