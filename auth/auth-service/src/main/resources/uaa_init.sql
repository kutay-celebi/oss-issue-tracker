...
INSERT INTO kuartz_uaa.uaa_user_table (id, created_at, deleted_at, deleted, updated_at, uuid, email, enabled, expiration_date, locked_date, password, username, person_id) VALUES (nextval('kuartz_uaa.user_seq'), current_timestamp, null, null, null, uuid_generate_v4(), 'azizerel@gmail.com', null, null, null, '$2a$10$8xczy4oBil0p/3wKBRU6duzxRDkuHUGYY4RbzuglAZ/TQusD6Jmdy', 'aerel', (select id from kuartz_uaa.uaa_person where name='Aziz'));
...
--  client init.
INSERT INTO kuartz_uaa.uaa_client_detail (id, created_at, deleted_at, deleted, updated_at, uuid, acces_token_validity_seconds, additional_information, authorities, authorized_grant_types, auto_approve_scopes, client_id, client_secret, refresh_token_validity_seconds, registered_redirect_uri, scope) VALUES (nextval('kuartz_uaa.client_seq'), current_timestamp, null, null, current_timestamp, uuid_generate_v4(), 1500, null, 'role_user', 'password', null, 'test', '$2a$10$8xczy4oBil0p/3wKBRU6duzxRDkuHUGYY4RbzuglAZ/TQusD6Jmdy', 1500, null, 'password');
