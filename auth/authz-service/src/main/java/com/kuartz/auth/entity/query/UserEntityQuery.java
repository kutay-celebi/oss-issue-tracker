...
public class UserEntityQuery extends EntityPathBase<UserEntity> {
    ...
    public final ListPath<com.kuartz.auth.entity.UserRoleEntity, UserRoleEntityQuery> roleList = this.<com.kuartz.auth.entity.UserRoleEntity, UserRoleEntityQuery>createList("roleList", com.kuartz.auth.entity.UserRoleEntity.class, UserRoleEntityQuery.class, PathInits.DIRECT2);
